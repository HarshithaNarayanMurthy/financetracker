...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into tblincome(UserId,IncomeDate,IncomeItem,IncomeCost) value('$userid','$dateincome','$item','$costitem')");
if($query){
						...
						<div class="col-md-12">
							...
							<form role="form" method="post" action="">
								<div class="form-group">
									...
									<input class="form-control" type="date" value="" name="dateincome" required="true" max="<?php echo date('Y-m-d', strtotime("-1 day")); ?>">
								</div>
								<div class="form-group">
									<label>Item</label>
