...
echo "<script>window.location.href='loanlog.php'</script>";
} else {
...
$ret=mysqli_query($con,"select * from log where type='loan';");
$cnt=1;
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="loanlog.php?delid=<?php echo $row['ID'];?>">Delete</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
