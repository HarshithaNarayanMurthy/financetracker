...
<style>
    body {background-image: url('includes/gift.jpg');
...
<p> <a href= "home.html" style = "background-image: url('includes/brick.jpg') ;font-family: 'Segoe Print';"><b> go back home</b> </a></p>
	...
	<h2 align="center" style="font-family: 'Segoe Print'"; >Register Here</h2>
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading" style="font-family: 'Segoe Print'";>Sign Up</div>
