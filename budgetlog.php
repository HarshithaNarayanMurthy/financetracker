...
echo "<script>window.location.href='budgetlog.php'</script>";
} else {
...
<head>
	...
	<title>AINsoft - Investment Log</title>
...
$ret=mysqli_query($con,"select * from log where type='budget';");
$cnt=1;
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="budgetlog.php?delid=<?php echo $row['ID'];?>">Delete</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
