...
echo "<script>window.location.href='insertedlog.php'</script>";
} else {
...
<head>
	...
	<title>HomFin - Manage Users Log</title>
...
$ret=mysqli_query($con,"select * from log where action='inserted';");
$cnt=1;
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="insertedlog.php?delid=<?php echo $row['ID'];?>">Delete</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
