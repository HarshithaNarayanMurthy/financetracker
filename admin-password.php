...
{
$userid=$_SESSION['detsaid'];
$cpassword=md5($_POST['currentpassword']);
$newpassword=md5($_POST['newpassword']);
$query=mysqli_query($con,"select ID from tbladmin where ID='$userid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbladmin set Password='$newpassword' where ID='$userid'");
...
<head>
	...
	<title>HomFin - Change Admin Password</title>
...
<body>
    ...
    echo $msg;
						...
						<div class="col-md-12">
							 <?php
$userid=$_SESSION['detsaid'];
$ret=mysqli_query($con,"select * from tbladmin where ID='$userid'");
$cnt=1;
