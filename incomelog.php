...
echo "<script>window.location.href='incomelog.php'</script>";
} else {
...
$ret=mysqli_query($con,"select * from log where type='income';");
$cnt=1;
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="incomelog.php?delid=<?php echo $row['ID'];?>">Delete</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
